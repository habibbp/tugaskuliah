...
class TransaksiController extends SecureController{
	...
	function index($fieldname = null , $fieldvalue = null){
		...
		if(!empty($request->search)){
			...
			$search_condition = "(
				...
				transaksi.total_transaksi LIKE ? OR 
				transaksi.cicilan LIKE ? OR 
				transaksi.garansi LIKE ?
			)";
			$search_params = array(
	...
	function view($rec_id = null, $value = null){
		...
		if($value){
			...
			$db->where("transaksi.id_transaksi", $rec_id);; //select record based on primary key
		}
	...
	function add($formdata = null){
		if($formdata){
			...
			$request = $this->request;
			//fillable fields
			$fields = $this->fields = array("id_pelanggan","tanggal","total_transaksi","cicilan","garansi");
			...
			$this->sanitize_array = array(
				...
				'total_transaksi' => 'sanitize_string',
				'cicilan' => 'sanitize_string',
				'garansi' => 'sanitize_string',
			);
	...
	function edit($rec_id = null, $formdata = null){
		...
		$tablename = $this->tablename;
		 //editable fields
		$fields = $this->fields = array("id_transaksi","id_pelanggan","tanggal","total_transaksi","cicilan","garansi");
		if($formdata){
			$postdata = $this->format_request_data($formdata);
			$this->rules_array = array(
				'id_pelanggan' => 'required',
