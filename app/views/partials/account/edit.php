                            ...
                            <div>
                                <div class="form-group ">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="">
                                                <input id="ctrl-name_pelanggan"  value="<?php  echo $data['name_pelanggan']; ?>" type="text" placeholder="Enter Name Pelanggan"  required="" name="name_pelanggan"  data-url="api/json/account_name_pelanggan_value_exist/" data-loading-msg="Checking availability ..." data-available-msg="Available" data-unavailable-msg="Not available" class="form-control  ctrl-check-duplicate" />
