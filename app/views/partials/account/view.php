                    ...
                    <div  class="card animated fadeIn page-content">
                        ...
                        <div class="bg-primary m-2 mb-4">
                            <div class="profile">
                                ...
                                <h1 class="title mt-4"><?php echo $data['name_pelanggan']; ?></h1>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-3">
                                        ...
                                        <div class="tab-pane show active fade" id="AccountPageView" role="tabpanel">
                                            <table class="table table-hover table-borderless table-striped">
                                                <tbody class="page-data" id="page-data-<?php echo $page_element_id; ?>">
                                                    ...
                                                    <tr  class="td-name_pelanggan">
                                                        <th class="title"> Name Pelanggan: </th>
                                                        <td class="value">
                                                            <span  data-value="<?php echo $data['name_pelanggan']; ?>" 
                                                                data-pk="<?php echo $data['id_pelanggan'] ?>" 
                                                                data-url="<?php print_link("pelanggan/editfield/" . urlencode($data['id_pelanggan'])); ?>" 
                                                                data-name="name_pelanggan" 
                                                                data-title="Enter Name Pelanggan" 
                                                                data-placement="left" 
                                                                data-toggle="click" 
                                                                data-type="text" 
                                                                data-mode="popover" 
