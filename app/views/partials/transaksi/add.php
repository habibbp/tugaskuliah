                                    ...
                                    <div class="form-group ">
                                        ...
                                        <div class="form-group ">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-8">
                                                    <div class="">
                                                        <input id="ctrl-total_transaksi"  value="<?php  echo $this->set_field_value('total_transaksi',""); ?>" type="text" placeholder="Enter Total Transaksi"  required="" name="total_transaksi"  class="form-control " />
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group ">
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <div class="">
                                                            <input id="ctrl-cicilan"  value="<?php  echo $this->set_field_value('cicilan',""); ?>" type="text" placeholder="Enter Cicilan"  required="" name="cicilan"  class="form-control " />
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group ">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-8">
                                                            <div class="">
                                                                <input id="ctrl-garansi"  value="<?php  echo $this->set_field_value('garansi',""); ?>" type="text" placeholder="Enter Garansi"  required="" name="garansi"  class="form-control " />
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
