                                ...
                                <div class="form-group ">
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <div class="form-group ">
                                            <div class="row">
                                                <div class="col-sm-4">
                                                    <label class="control-label" for="total_transaksi">Total Transaksi <span class="text-danger">*</span></label>
                                                </div>
                                                <div class="col-sm-8">
                                                    <div class="">
                                                        <input id="ctrl-total_transaksi"  value="<?php  echo $data['total_transaksi']; ?>" type="text" placeholder="Enter Total Transaksi"  required="" name="total_transaksi"  class="form-control " />
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group ">
                                                <div class="row">
                                                    <div class="col-sm-4">
                                                        <label class="control-label" for="cicilan">Cicilan <span class="text-danger">*</span></label>
                                                    </div>
                                                    <div class="col-sm-8">
                                                        <div class="">
                                                            <input id="ctrl-cicilan"  value="<?php  echo $data['cicilan']; ?>" type="text" placeholder="Enter Cicilan"  required="" name="cicilan"  class="form-control " />
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group ">
                                                    <div class="row">
                                                        <div class="col-sm-4">
                                                            <label class="control-label" for="garansi">Garansi <span class="text-danger">*</span></label>
                                                        </div>
                                                        <div class="col-sm-8">
                                                            <div class="">
                                                                <input id="ctrl-garansi"  value="<?php  echo $data['garansi']; ?>" type="text" placeholder="Enter Garansi"  required="" name="garansi"  class="form-control " />
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
