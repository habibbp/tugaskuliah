...
define("SITE_NAME", "PENJUAL MOTOR");
...
define("APP_ID", "0d3a3b20bf6836745c2ed93078954cec");
...
define('USER_ID',(isset($_SESSION[APP_ID.'user_data']) ? $_SESSION[APP_ID.'user_data']['id_pelanggan'] : null ));
define('USER_NAME',(isset($_SESSION[APP_ID.'user_data']) ? $_SESSION[APP_ID.'user_data']['name_pelanggan'] : null ));
